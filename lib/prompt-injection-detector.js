...
/**
 * Checks if a string is likely to be a Base64-encoded token.
 * 
 * @param {string} token - The string to validate
 * @returns {boolean} True if the string appears to be a valid Base64 token
 */
...
/**
 * Decodes a Base64-encoded token to UTF-8 string.
 * 
 * @param {string} token - The Base64 token to decode
 * @returns {string} The decoded string, or empty string on failure
 */
...
/**
 * Validates if a string contains printable text characters.
 * 
 * @param {string} value - The string to check
 * @returns {boolean} True if the string contains printable ASCII text
 */
 ...
 * 
 * @param {string} input - The user input string to analyze
 * @returns {{blocked: boolean, reason: string|null, matches: string[]}} Analysis result with detection details
 */
...
/**
 * Extracts prompt text from various input structures.
 * 
 * @param {object} input - The input object that may contain prompt text
 * @returns {string|null} The extracted prompt string, or null if none found
 */
